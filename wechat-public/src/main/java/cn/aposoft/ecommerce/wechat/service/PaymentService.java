...
public interface PaymentService {
     ...
     * @author
     */
    WeChatPayResData pay(OrderParams orderParams, BaseWechatConfig config);
     ...
     * @author Yujinshui
     */
    WechatPayQueryResData query(OrderQueryParams orderQueryParams, BaseWechatConfig config);
     ...
     * params)
     */
    CloseResData closeOrder(CloseOrderParams params, BaseWechatConfig config);
     ...
     * @author Yujinshui
     */
    WeChatRefundResData refund(RefundParams refund, BaseWechatConfig config);
     ...
     * @author codejiayou
     */
    WechatRefundQueryResData refundQuery(RefundQueryParams params, BaseWechatConfig config);
     ...
     * @author codejiayou
     */
    DownloadBillResData downloadBill(DownloadBillParams params, BaseWechatConfig config);
