...
public class ScanPayReqData {
     ...
     */
    public ScanPayReqData(WechatConfigure configure, String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String
		    spBillCreateIP,
                          String
		    timeStart,String timeExpire,String goodsTag){
